...
OutputBaseFilename=usbavrlabboundary_{#FullTarget}
DefaultDirName={pf}\{#AppName}
DefaultGroupName={#AppName}
UninstallDisplayIcon={app}\usbavrboundary.exe

[Files]
Source: ..\..\output\i386-win32\usbavrboundary.exe; DestDir: {app}; Components: main
Source: ..\..\data\*.bsd; DestDir: {app}\data; Components: main
...
[Icons]
Name: {group}\USB AVR Lab Boundary Scan Tool; Filename: {app}\usbavrboundary.exe; Workingdir: {app}
Name: {group}\Internet; Filename: {app}\website.url
Name: {userdesktop}\USB AVR Lab Boundary Scan Tool; Filename: {app}\usbavrboundary.exe; Tasks: desktopicon
...
begin
     ...
     nCode    := IssSurvey('de',sReasons,'http://update.ullihome.de/IssSurvey_mail.php','bstool','demo');
